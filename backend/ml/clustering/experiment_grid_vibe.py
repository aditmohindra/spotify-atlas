...
FULL_RUNS = [
    (50,  0.0, 'vibe'),   # mirror of run 18 winning params
    (100, 0.0, 'vibe'),   # more global structure
]
...
def run_grid():
    ...
    for umap_idx, (n_neighbors, min_dist, doc_type) in enumerate(FULL_RUNS):
        ...
        base_config = {
            ...
            "notes": (
                f"ML-2d grid: {doc_type} n_neighbors={n_neighbors} "
